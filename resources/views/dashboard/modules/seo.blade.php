        ...
        @foreach(Helper::languagesList() as $ActiveLanguage)
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    $seo_example_url = Helper::sectionURL($WebmasterSections->id, @$ActiveLanguage->code,$WebmasterSections);
                    ?>
                    <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $("#seo_url_slug_{{ @$ActiveLanguage->code }}").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#url_in_engines_{{ @$ActiveLanguage->code }}").text("<?php echo Helper::sectionURL($WebmasterSections->id, @$ActiveLanguage->code,$WebmasterSections); ?>");
            }
        });
        @endforeach
    </script>
