            ...
            <div class="box-body">
                ...
                @foreach(Helper::languagesList() as $ActiveLanguage)
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('title_'.@$ActiveLanguage->code,$WebmasterBanners->{'title_'.@$ActiveLanguage->code}, array('placeholder' => '','class' => 'form-control','required'=>'','maxlength'=>191, 'dir'=>@$ActiveLanguage->direction)) !!}
                        </div>
                    </div>
                @endforeach
                <div class="form-group row">
