    ...
    <div class="p-a-md col-md-12">
        ...
        <div class="form-group"
            ...
            <div class="box p-a-xs">
                {!! Form::textarea('close_msg',$Setting->close_msg, array('ui-jp'=>'summernote','class' => 'form-control summernote_'.@Helper::currentLanguage()->code,'ui-options'=>'{height: 300,callbacks: {
