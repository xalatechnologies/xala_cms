        ...
        <div class="box-body">
            @if (Session::has('commentST'))
                @if (Session::get('commentST') == "create")
                    ...
                    <div>
                        {{Form::open(['route'=>['topicsCommentsStore',$WebmasterSection->id,$Topic->id],'method'=>'POST', 'files' => true ])}}
                ...
                @if (Session::get('commentST') == "edit")
                    <div>
                        {{Form::open(['route'=>['topicsCommentsUpdate',$WebmasterSection->id,$Topic->id,Session::get('Comment')->id],'method'=>'POST', 'files' => true ])}}
            ...
            @else
                ...
                @endif
                @if(count($Topic->comments)>0)
                    {{Form::open(['route'=>['topicsCommentsUpdateAll',$WebmasterSection->id,$Topic->id],'method'=>'post'])}}
