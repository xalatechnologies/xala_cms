...
class BannersSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $Banner->title_br = "Estandarte nº 1";

        $Banner->details_ar = "هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء لصفحة ما سيلهي القارئ عن التركيز على الشكل الخارجي للنص. هناك حقيقة  وهي أن المحتوى المقروء لصفحة ما سيلهي القارئ.";
        $Banner->details_en = "It is a long established fact that a reader will be distracted by the readable content of a page. It is a long established fact that a reader will be distracted.";
        ...
        $Banner->details_br = "É um fato há muito estabelecido que um leitor será distraído pelo conteúdo legível de uma página.";
        ...
        $Banner->title_br = "Responsive Design";
        ...
        $Banner->title_br = "Classic Design";
