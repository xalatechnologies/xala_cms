...
class WebmasterSettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $settings->menus_status = true;
        $settings->file_manager_status = true;
        $settings->popups_status = true;
        $settings->tags_status = true;
        ...
        $settings->home_content4_section_id = 5;
        $settings->home_content5_section_id = 12;
        $settings->home_content6_section_id = 11;
        $settings->home_content7_section_id = 10;
        $settings->home_contents_per_page = "20";
        $settings->latest_news_section_id = "3";
        $settings->links_status = true;
        ...
        $settings->header_search_status = true;
        $settings->cookie_policy_status = true;
        $settings->timezone = "UTC";

        $settings->version = "10.0.4";
        $settings->license = 0;

        $settings->mail_title = '{title}';
        $settings->mail_template = '{details}';

        $settings->image_optimize = 0;
