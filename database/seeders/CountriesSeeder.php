...
class CountriesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($Countries as $Country) {
            $Country->title_ch = $Country->title_en;
            $Country->title_hi = $Country->title_en;
            $Country->title_es = $Country->title_en;
            $Country->title_ru = $Country->title_en;
            $Country->title_pt = $Country->title_en;
            $Country->title_fr = $Country->title_en;
            $Country->title_de = $Country->title_en;
            $Country->title_th = $Country->title_en;
            $Country->title_br = $Country->title_en;
            $Country->save();
        }
